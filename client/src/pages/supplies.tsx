          ...
          <>
            ...
            <section className="flex items-start gap-3 rounded-lg border border-border bg-muted/35 p-4" data-testid="note-supplies-no-double-count">
              ...
              <p className="text-xs leading-5 text-muted-foreground">
                Supply purchases are a management view, not a replacement for order-level costing. Enter material and shipping from Queue → Ops (labor absorbed · free USPS packaging = $0) so HubSpot gross profit stays accurate.
              </p>
            </section>
          </>
        )}
