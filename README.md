...
- Prefer secure credential injection through `CUSTOM_CRED_PAID_ORDER_INTAKE_V4_LOCAL_TOKEN`.
...
| `CUSTOM_CRED_PAID_ORDER_INTAKE_V4_LOCAL_TOKEN` | Preferred for Paid Order Intake | Securely injected current access code required to analyze or create a paid Marketplace order. |
